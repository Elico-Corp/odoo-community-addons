    ...
    _columns = {
        'property_account_prepayable': fields.property(
            ...
            help="This account will be used instead of the default one "
                 "as the prepayment payable account for the current partner",
            required=True,
        ),
        'property_account_prereceivable': fields.property(
            ...
            help="This account will be used instead of the default one "
                 "as the prepayment receivable account for the current partner",
            required=True,
        ),
    }
...
class account_voucher(osv.osv):
    ...
    _columns = {
        'use_prepayment_account': fields.boolean('Use Prepayment account',
            help="Check this if you want to "
                 "input a prepayment on the prepayment accounts.",
        ),
            ...
            if voucher_brw.use_prepayment_account:
                if voucher_brw.payment_option == 'with_writeoff':
                    ...
                    if not voucher_brw.partner_id.property_account_prereceivable:
                        raise osv.except_osv(_('Unable to validate payment !'),
                    ...
                    if not voucher_brw.partner_id.property_account_prepayable:
                        raise osv.except_osv(_('Unable to validate payment !'),
                                             _('Please configure the partner Prepayable '
                                               'Account at first!'))
