...
class stock_partial_picking(orm.TransientModel):
    ...
    def _product_cost_for_average_update(self, cr, uid, move):
        ...
        if move.purchase_line_id:
            if move.purchase_line_id.remaining_qty:
                res['cost'] = move.purchase_line_id.price_unit +\
                    (move.purchase_line_id.landing_costs / move.purchase_line_id.remaining_qty)
